...
export default function DashboardSidebar({ user }) {
  ...
  const userNavLinks = [
    ...
    { icon: Person, href: "/dashboard/my-favorites", label: "My Favorites" }, // আপনি চাইলে আইকন চে数字化 করতে পারেন
  ...
  return (
    <div className="bg-[#0f0f11] border-r border-zinc-800/50 w-64 min-h-screen p-6 flex flex-col justify-between">
      ...
      <div className="flex flex-col gap-1.5 pt-4 border-t border-zinc-800/50">
        <Link
          href="/"

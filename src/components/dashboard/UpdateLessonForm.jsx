...
export default function UpdateLessonForm({ lesson, user }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await updateLesson(lesson._id, finalData);
      if (res?.success || res) {
  ...
  return (
    <div>
      {/* Heading */}
      <h1 className="text-2xl font-bold text-white">Update Lesson</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <select
              ...
              onChange={handleChange}
              className="w-full bg-[#1a1a1a] border border-zinc-700 focus:border-indigo-500 rounded-xl p-3 text-white text-sm outline-none transition-all cursor-pointer"
            >
